# VEDLIKEHOLD-VÆR ANALYSE 2022-2025

**Generert:** 10.08.2025 11:22
...
- **rain_on_cold_surface**: 66 episoder (39.8%)
- **snow_plowing**: 21 episoder (12.7%)
- **slush_scraping**: 2 episoder (1.2%)
- **freeze_thaw_salting**: 2 episoder (1.2%)
- **unnecessary_treatment**: 1 episoder (0.6%)

**Detaljerte værkriterier:**

**Regn på kald bakke** (66 episoder):
- Gjennomsnittstemperatur: -3.4°C
- Gjennomsnittlig nedbør: 24.7mm
- KRITISK: Regn på frostkald bakke = farlig is-dannelse
