...
def create_balanced_slippery_analysis():
    ...
    if 'relative_humidity' in df.columns:
        ...
        print(f"💧 Ingen fuktighetsmålinger tilgjengelig")
    ...
    if 'wind_speed' in df.columns:
        ...
        print(f"💨 Ingen vindmålinger tilgjengelig")
    ...
    if humidity_available.any() and wind_available.any():
        ...
        print(f"✅ Bruker FULL analyse (temp + fuktighet + vind + tid - snøfall)")
        ...
        print(f"✅ Bruker REDUSERT analyse (temp + fuktighet + tid - snøfall)")
        ...
        print(f"✅ Bruker MINIMAL analyse (temp + tid - snøfall)")
    ...
    if periods:
        ...
        print(f"❌ Første (urealistisk): 420 perioder")
        print(f"❌ Andre (for streng): 0 perioder")
