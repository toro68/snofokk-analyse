...
def load_analysis_results() -> dict[str, dict]:
    ...
    # Original analyse
    try:
        with open(f'{base_path}/winter_snowdrift_analysis.json') as f:
    ...
    # Forbedret analyse
    try:
        with open(f'{base_path}/enhanced_snowdrift_analysis.json') as f:
    ...
    try:
        with open(f'{base_path}/fixed_enhanced_snowdrift_analysis.json') as f:
