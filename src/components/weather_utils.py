...
def simple_snowdrift_analysis(temp: float, wind: float, snow_depth: Optional[float] = None) -> Dict[str, Any]:
...
def simple_slippery_analysis(temp: float, surface_temp: Optional[float] = None, 
