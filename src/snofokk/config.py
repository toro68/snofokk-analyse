...
class Settings(BaseSettings):
    ...
    confidence_extreme_depth_threshold: float = core_settings.legacy_snofokk.confidence_extreme_depth_threshold
    confidence_extreme_depth_penalty: float = core_settings.legacy_snofokk.confidence_extreme_depth_penalty
    confidence_extreme_change_threshold: float = core_settings.legacy_snofokk.confidence_extreme_change_threshold
    confidence_extreme_change_penalty: float = core_settings.legacy_snofokk.confidence_extreme_change_penalty
    ...
    blowing_snow_depth_medium_cm: float = core_settings.enhanced_weather.blowing_snow_depth_medium_cm
    blowing_snow_depth_high_add: float = core_settings.enhanced_weather.blowing_snow_depth_high_add
    blowing_snow_depth_medium_add: float = core_settings.enhanced_weather.blowing_snow_depth_medium_add
    ...
    blowing_temp_wet_snow_penalty: float = core_settings.enhanced_weather.blowing_temp_wet_snow_penalty
    ...
    visibility_precip_multiplier: float = core_settings.enhanced_weather.visibility_precip_multiplier
    visibility_min_km: float = core_settings.enhanced_weather.visibility_min_km

    combined_blowing_risk_weight: float = core_settings.enhanced_weather.combined_blowing_risk_weight
    ...
    visibility_impact_high_risk_min: float = core_settings.enhanced_weather.visibility_impact_high_risk_min
    visibility_impact_medium_risk_min: float = core_settings.enhanced_weather.visibility_impact_medium_risk_min

    road_critical_wind_min_ms: float = core_settings.enhanced_weather.road_critical_wind_min_ms
    road_challenging_wind_min_ms: float = core_settings.enhanced_weather.road_challenging_wind_min_ms
    ...
    analysis_wind_hours_above_ms: float = core_settings.enhanced_weather.analysis_wind_hours_above_ms
    analysis_snow_available_min_cm: float = core_settings.enhanced_weather.analysis_snow_available_min_cm
    analysis_precip_any_min_mmph: float = core_settings.enhanced_weather.analysis_precip_any_min_mmph
    analysis_blowing_snow_hours_risk_min: float = core_settings.enhanced_weather.analysis_blowing_snow_hours_risk_min

    deterioration_trend_tail_points: int = core_settings.enhanced_weather.deterioration_trend_tail_points
    deterioration_wind_trend_high: float = core_settings.enhanced_weather.deterioration_wind_trend_high
    deterioration_risk_trend_high: float = core_settings.enhanced_weather.deterioration_risk_trend_high
    deterioration_wind_trend_low: float = core_settings.enhanced_weather.deterioration_wind_trend_low
    deterioration_risk_trend_low: float = core_settings.enhanced_weather.deterioration_risk_trend_low
    ...
    action_medium_wind_max_min_ms: float = core_settings.enhanced_weather.action_medium_wind_max_min_ms
